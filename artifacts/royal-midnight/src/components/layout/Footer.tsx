      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="block mb-6">
              <img src="/royal-midnight-logo-transparent.png" alt="Royal Midnight" className="h-28 w-auto max-w-xs object-contain object-left" />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="mailto:support@royalmidnight.com" className="text-gray-400 hover:text-primary text-sm transition-colors">support@royalmidnight.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link href="/driver-agreement" className="text-gray-500 text-xs hover:text-white transition-colors">Chauffeur Agreement</Link>
          </div>
        </div>
      </div>
    </footer>
